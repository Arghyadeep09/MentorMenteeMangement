...
//       const response = await axios.get(`https://mentormenteemangement.onrender.com/api/mentors/available-slots?date=${dayOfWeek}`);
...
//     try {
//       const response = await axios.get("https://mentormenteemangement.onrender.com/api/bookings");
...
//     try {
//       await axios.post("https://mentormenteemangement.onrender.com/book-slot", {
//         mentorId,
//         slot: slotTime,
//       });
...
//       // Fetch available slots for this weekday
//       const response = await axios.get(`https://mentormenteemangement.onrender.com/api/mentor/available-slots?date=${dayOfWeek}`);
//       console.log("Mentor Slots:", response.data);
//       setMentorSlots(response.data);
//     } catch (error) {
//       console.error("Error fetching mentor slots:", error);
...
const MenteeDashboard = () => {
  ...
  const fetchMentorSlots = async (selectedDate) => {
    try {
      ...
      console.log(`Fetching available slots for: ${dayOfWeek}`);
      const response = await axios.get(
        `https://mentormenteemangement.onrender.com/api/mentor/available-slots?date=${dayOfWeek}`
      );
      setMentorSlots(response.data);
    } catch (error) {
      console.error("Error fetching mentor slots:", error);
